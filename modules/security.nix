# Based on https://github.com/wimpysworld/nix-config/blob/f6360f41cf0284cb3952479729b5451e85ce535f/nixos/_mixins/services/clamav.nix
{
  config,
  pkgs,
  lib,
...
in
{
  config = lib.mkMerge [
    {
      services.clamav.daemon.enable = !pkgs.stdenv.hostPlatform.isRiscV;
    }
